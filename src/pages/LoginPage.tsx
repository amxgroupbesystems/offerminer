  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 text-slate-100">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 className="text-3xl font-extrabold text-white">OfferMiner</h2>
        <p className="mt-2 text-sm text-slate-400">
          Faça login para acessar suas ofertas e pesquisas
        </p>
      </div>
        ...
        <div className="bg-slate-900/80 backdrop-blur-md py-8 px-4 shadow-xl border border-slate-800 sm:rounded-2xl sm:px-10">
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between text-sm">
              <Link to="/esqueci-a-senha" className="font-medium text-blue-400 hover:text-blue-300">
                Esqueceu sua senha?
              </Link>
            </div>
